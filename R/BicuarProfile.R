...
#'   \item{TreeHeight}{Value or column name in data set @ForestGeoSubset (height_m) corresponding to Tree height}
#'   \item{Date}{Value or column name in data set @ForestGeoSubset (census_date) corresponding to Date of measurement}
...
#'   \item{POM}{Value or column name in data set @ForestGeoSubset (pom_m) corresponding to POM}
...
#'   \item{IdStem}{Value or column name in data set @ForestGeoSubset (stem_id) corresponding to Stem ID}
...
#'   \item{IdMeasure}{Value or column name in data set @ForestGeoSubset (measurement_id) corresponding to Measure ID}
...
#'   \item{ScientificName}{Value or column name in data set @ForestGeoSubset (taxon_name) corresponding to Scientific name}
...
#'   \item{Site}{Value or column name in data set @ForestGeoSubset (site_id) corresponding to Site name}
#'   \item{TreeLon}{Value or column name in data set @ForestGeoSubset (none) corresponding to Tree longitude}
#'   \item{Plot}{Value or column name in data set @ForestGeoSubset (plot_id) corresponding to Plot name}
#'   \item{IdTree}{Value or column name in data set @ForestGeoSubset (tree_id) corresponding to Tree ID}
...
#'   \item{Subplot}{Value or column name in data set @ForestGeoSubset (subplot_id) corresponding to Subplot name}
...
#'   \item{Diameter}{Value or column name in data set @ForestGeoSubset (diam_cm) corresponding to DBH}
